...
\begin{align*}
  ...
  = &\begin{mistake}\int 1/2(1 - cos2x) (1 + cos2x) dx  \end{mistake} \\
...
\begin{align*}
  ...
  = &\begin{mistake}\lim_{t \to -\infty} e^{-t} \end{mistake}\\
  = &0
\end{align*}
...
since angles are modulo \begin{mistake}0\end{mistake} and the angle of a full circle ($360^o$ or
...
can be infinitely long such as $1,2,3,...$, and can be defined as \begin{mistake}$a_n
= n$\end{mistake} where $a_n$ is the $n$th term in the sequence.
