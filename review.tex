...
A power series is of the form $\sum c_n(x-a)^n$.  Also, we define $(x-a)^0$ as 1 even when $x=a$ for convenience.
...
A Taylor series is when function $f(x)$ can be approximated $\sum \frac{f^{(n)}(a)x^n}{n!}$.
